...
JSLib.Modal = Class.create({
  ...
  createModal: function(){
    ...
    this.modal = new Element('div', { style: "position:absolute;top: 0px;left: 0px;zIndex:"+($zIndex++)+";background:#FFF;"});
    this.modal.hide();
  ...
  this.overlay = new Element('div', { style: "position:absolute; top: 0px;left: 0px;zIndex:"+($zIndex++)+";"});
    this.overlay.hide();
